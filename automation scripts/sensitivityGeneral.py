...
for multiple in multiples:
    ...
    inputOfDebtRatio = driver.find_element_by_xpath("//div[@id='sidebar']/div[5]/form/div[29]/div/input")
...
for multiple in multiples:
    ...
    # change input of Debt Ratio
    inputOfDebtInterestRate = driver.find_element_by_xpath("//div[@id='sidebar']/div[5]/form/div[30]/div/input")
...
for multiple in multiples:
    ...
    # change input of Debt Ratio
    inputOfCostOfEqulity = driver.find_element_by_xpath("//div[@id='sidebar']/div[5]/form/div[32]/div/input")
...
for multiple in multiples:
    ...
    # change input of Debt Ratio
    inputOfNetEfficiency = driver.find_element_by_xpath("//div[@id='sidebar']/div[5]/form/div[6]/div/input")
...
for multiple in multiples:
    ...
    # change input of Debt Ratio
    inputOfCapacityFactor = driver.find_element_by_xpath("//div[@id='sidebar']/div[5]/form/div[4]/div/input")
