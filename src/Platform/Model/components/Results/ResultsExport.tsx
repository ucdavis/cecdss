  ...
  const makeClusterExcel = async () => {
    ...
    props.yearlyResults.forEach((data, index) => {
      ...
      worksheet.columns = [
        ...
        { header: 'Biomass (Dry US Tons)', key: 'biomass', width: 20 },
        ...
        { header: 'Landing Distance (m)', key: 'landing_distance', width: 15 },
        ...
        { header: 'Yield Per Acre (green tons/acre)', key: 'frcsResult_total_yieldPerAcre', width: 15 },
        { header: 'Cost Per Acre ($/acre)', key: 'frcsResult_total_costPerAcre', width: 15 },
        { header: 'Cost Per Bole CCF ($/bole CCF)', key: 'frcsResult_total_costPerBoleCCF', width: 15 },
        { header: 'Cost Per GT ($/green ton)', key: 'frcsResult_total_costPerGT', width: 15 },
        { header: 'Diesel Per Acre (gal/acre)', key: 'frcsResult_total_dieselPerAcre', width: 15 },
        { header: 'Diesel Per Bole CCF (gal/bole CCF)', key: 'frcsResult_total_dieselPerBoleCCF', width: 15 },
        { header: 'Gasoline Per Acre (gal/acre)', key: 'frcsResult_total_gasolinePerAcre', width: 15 },
        { header: 'Gasoline Per Bole CCF (gal/bole CCF)', key: 'frcsResult_total_gasolinePerBoleCCF', width: 15 },
        { header: 'Jet Fuel Per Acre (gal/acre)', key: 'frcsResult_total_jetFuelPerAcre', width: 15 },
        { header: 'Jet Fuel Per Bole CCF (gal/bole CCF)', key: 'frcsResult_total_jetFuelPerBoleCCF', width: 15 },

        { header: 'Yield Per Acre (green tons/acre)', key: 'frcsResult_residual_yieldPerAcre', width: 15 },
        { header: 'Cost Per Acre ($/acre)', key: 'frcsResult_residual_costPerAcre', width: 15 },
        { header: 'Cost Per Bole CCF ($/bole CCF)', key: 'frcsResult_residual_costPerBoleCCF', width: 15 },
        { header: 'Cost Per GT ($/green ton)', key: 'frcsResult_residual_costPerGT', width: 15 },
        { header: 'Diesel Per Acre (gal/acre)', key: 'frcsResult_residual_dieselPerAcre', width: 15 },
        { header: 'Diesel Per Bole CCF (gal/bole CCF)', key: 'frcsResult_residual_dieselPerBoleCCF', width: 15 },
        { header: 'Gasoline Per Acre (gal/acre)', key: 'frcsResult_residual_gasolinePerAcre', width: 15 },
        { header: 'Gasoline Per Bole CCF (gal/bole CCF)', key: 'frcsResult_residual_gasolinePerBoleCCF', width: 15 },
        { header: 'Jet Fuel Per Acre (gal/acre)', key: 'frcsResult_residual_jetFuelPerAcre', width: 15 },
        { header: 'Jet Fuel Per Bole CCF (gal/bole CCF)', key: 'frcsResult_residual_jetFuelPerBoleCCF', width: 15 },
      ];
